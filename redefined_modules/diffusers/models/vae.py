...
from ...activations import QcSiLU
...
class VQModel(ModelMixin, ConfigMixin):
    ...
    def encode(self, x: torch.FloatTensor,  return_dict: bool= False) -> VQEncoderOutput:
        h = self.encoder(x)
        h = self.quant_conv(h)
    ...
    def decode(
        self, h: torch.FloatTensor, force_not_quantize: bool = False, return_dict: bool = False
    ...
    def forward(self, sample: torch.FloatTensor, return_dict: bool = False) -> Union[DecoderOutput, torch.FloatTensor]:
        r"""
        Args:
