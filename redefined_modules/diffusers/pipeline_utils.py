...
from diffusers.hub_utils import http_user_agent, send_telemetry
...
LOADABLE_CLASSES = {
    ...
    "redefined_modules.diffusers.models.unet_2d_condition": {
        "ModelMixin": ["save_pretrained", "from_pretrained"],
        "SchedulerMixin": ["save_pretrained", "from_pretrained"],
        "DiffusionPipeline": ["save_pretrained", "from_pretrained"],
        "OnnxRuntimeModel": ["save_pretrained", "from_pretrained"],
    },
    "redefined_modules.diffusers.models.vae": {
        "ModelMixin": ["save_pretrained", "from_pretrained"],
        "SchedulerMixin": ["save_pretrained", "from_pretrained"],
        "DiffusionPipeline": ["save_pretrained", "from_pretrained"],
        "OnnxRuntimeModel": ["save_pretrained", "from_pretrained"],
    },
    "redefined_modules.transformers.models.clip.modeling_clip": {
        "PreTrainedTokenizer": ["save_pretrained", "from_pretrained"],
        "PreTrainedTokenizerFast": ["save_pretrained", "from_pretrained"],
        "PreTrainedModel": ["save_pretrained", "from_pretrained"],
        "FeatureExtractionMixin": ["save_pretrained", "from_pretrained"],
...
class DiffusionPipeline(ConfigMixin):
    ...
    def from_pretrained(cls, pretrained_model_name_or_path: Optional[Union[str, os.PathLike]], **kwargs):
        ...
        if "text_encoder" in config_dict:
            config_dict["text_encoder"][0] = "redefined_modules.transformers.models.clip.modeling_clip"
        if "unet" in config_dict:
            config_dict["unet"][0] = "redefined_modules.diffusers.models.unet_2d_condition"
        if "vae" in config_dict:
            config_dict["vae"] = ["redefined_modules.diffusers.models.vae", "AutoencoderKLDecoder"]
